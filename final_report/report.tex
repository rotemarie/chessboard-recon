...
\author{\IEEEauthorblockN{Shon Grinberg, David Paster, Rotem Arie}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.48\textwidth]{demo_squares.jpg}
\caption{Grid of 64 extracted squares (8x8) ready for classification. Each square is 64x64 pixels.}
\label{fig:demo_squares}
\end{figure}
...
\begin{enumerate}
    \item \textbf{ResNet18:} 11M parameters, good speed-accuracy tradeoff \cite{he2016deep}
    \item \textbf{ResNet50:} 23M parameters, better feature extraction \cite{he2016deep}
    \item \textbf{VGG16:} 138M parameters, deeper architecture \cite{simonyan2015very}
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Render board visualization from FEN and mark unknown squares with X
\end{enumerate}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{error_visualization.png}
\caption{Comprehensive error analysis showing misclassified samples with their predicted labels, true labels, and confidence scores. Highlights common failure modes including piece cropping, similar piece confusion, and occlusions.}
\label{fig:error_viz}
\end{figure*}
